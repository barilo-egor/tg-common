...
class EditMessageReplyKeyboardTest {
    ...
    void shouldCreateWithPassedParameters(Long chatId, Integer messageId) {
        ...
        new EditMessageReplyKeyboard(methodExecutor, chatId, messageId, expectedKeyboard)
                .send();
        var deleteMessageArgumentCaptor = ArgumentCaptor.forClass(EditMessageReplyMarkup.class);
