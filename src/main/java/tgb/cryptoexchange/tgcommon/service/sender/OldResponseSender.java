...
@Component
@Slf4j
public class OldResponseSender {

    private final BotInstance bot;
    private final KeyboardBuilder keyboardBuildService;

    public OldResponseSender(BotInstance bot, KeyboardBuilder keyboardBuildService) {
        this.bot = bot;
     ...
     */
    public Optional<Message> sendMessage(@NonNull Long chatId, @NonNull String text) {
     ...
     * @return сообщение, если оно было успешно доставлено
     */
    public Optional<Message> sendMessage(@NonNull Long chatId, @NonNull String text, Integer replyToMessageId) {
     ...
     * @return сообщение, если оно было успешно доставлено
     */
    public Optional<Message> sendMessage(@NonNull Long chatId, @NonNull String text, ReplyButton... replyButtons) {
     ...
     * @return сообщение, если оно было успешно доставлено
     */
    public Optional<Message> sendMessage(@NonNull Long chatId, @NonNull String text, InlineButton... inlineButtons) {
     ...
     * @return сообщение, если оно было успешно доставлено
     */
    public Optional<Message> sendMessage(@NonNull Long chatId, @NonNull String text, List<InlineButton> inlineButtons) {
    ...
    public Optional<Message> sendMessage(@NonNull Long chatId, @NonNull String text, ReplyKeyboard replyKeyboard, Integer replyToMessageId) {
        return sendMessage(chatId, text, replyKeyboard, replyToMessageId, ParseMode.HTML);
    }
     ...
     */
    public Optional<Message> sendMessage(@NonNull Long chatId, @NonNull String text, ReplyKeyboard replyKeyboard,
                                         Integer replyToMessageId, ParseMode parseMode) {
        ...
        try {
            ...
            log.error("Ошибка отправки sendMessage={}, ошибка: ", sendMessage.toString(), e);
        }
     ...
     * @param text   текст сообщения
     */
    public void sendMessageThrows(@NonNull Long chatId, @NonNull String text) throws TelegramApiException {
        bot.execute(SendMessage.builder()
                .chatId(chatId.toString())
                .text(text)
                .parseMode(ParseMode.HTML.getValue())
                .build());
    }
     ...
     * @return сообщение, если оно было успешно доставлено
     */
    public Optional<Message> sendPhoto(@NonNull Long chatId, String caption, @NonNull InputFile photo) {
     ...
     * @return сообщение, если оно было успешно доставлено
     */
    public Optional<Message> sendPhoto(@NonNull Long chatId, String caption, @NonNull String photo, ReplyKeyboard replyKeyboard) {
     ...
     * @return сообщение, если оно было успешно доставлено
     */
    public Optional<Message> sendPhoto(@NonNull Long chatId, String caption, @NonNull String photo) {
     ...
     * @return сообщение, если оно было успешно доставлено
     */
    public Optional<Message> sendPhoto(@NonNull Long chatId, String caption, @NonNull InputFile photo, ReplyKeyboard replyKeyboard) {
        try {
     ...
     * @return сообщение, если оно было успешно доставлено
     */
    public Optional<Message> sendAnimation(Long chatId, File file) {
    ...
    public Optional<Message> sendAnimation(Long chatId, String caption, String animation, ReplyKeyboard replyKeyboard) {
        return sendAnimation(chatId, new InputFile(animation), caption, replyKeyboard);
    }
     ...
     * @return сообщение, если оно было успешно доставлено
     */
    public Optional<Message> sendAnimation(Long chatId, InputFile animation, String caption, ReplyKeyboard replyKeyboard) {
        try {
